...
Version  : 5.22.0
Release  : 48
URL      : https://download.kde.org/stable/plasma/5.22.0/plasma-workspace-wallpapers-5.22.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.22.0/plasma-workspace-wallpapers-5.22.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.22.0/plasma-workspace-wallpapers-5.22.0.tar.xz.sig
...
%prep
%setup -q -n plasma-workspace-wallpapers-5.22.0
cd %{_builddir}/plasma-workspace-wallpapers-5.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623308968
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-workspace-wallpapers-5.22.0/COPYING %{buildroot}/usr/share/package-licenses/plasma-workspace-wallpapers/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/plasma-workspace-wallpapers-5.22.0/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/plasma-workspace-wallpapers/f45ee1c765646813b442ca58de72e20a64a7ddba
pushd clr-build
%make_install
popd
