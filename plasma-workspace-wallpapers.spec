...
Source0  : https://download.kde.org/stable/plasma/5.13.4/plasma-workspace-wallpapers-5.13.4.tar.xz
...
%prep
%setup -q -n plasma-workspace-wallpapers-5.13.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1535151686
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
