...
Version  : 6.3.5
Release  : 114
URL      : https://download.kde.org/stable/plasma/6.3.5/plasma-workspace-wallpapers-6.3.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.5/plasma-workspace-wallpapers-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/plasma-workspace-wallpapers-6.3.5.tar.xz.sig
...
%setup -q -n plasma-workspace-wallpapers-6.3.5
cd %{_builddir}/plasma-workspace-wallpapers-6.3.5
pushd ..
cp -a plasma-workspace-wallpapers-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747152540
mkdir -p clr-build
pushd clr-build
