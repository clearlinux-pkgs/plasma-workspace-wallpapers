...
Source0  : https://download.kde.org/stable/plasma/5.13.5/plasma-workspace-wallpapers-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/plasma-workspace-wallpapers-5.13.5.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0 LGPL-3.0
Requires: plasma-workspace-wallpapers-license
Requires: plasma-workspace-wallpapers-data
...
%prep
%setup -q -n plasma-workspace-wallpapers-5.13.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1536090211
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536090211
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/plasma-workspace-wallpapers
cp COPYING %{buildroot}/usr/share/doc/plasma-workspace-wallpapers/COPYING
cp COPYING.LGPL3 %{buildroot}/usr/share/doc/plasma-workspace-wallpapers/COPYING.LGPL3
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/plasma-workspace-wallpapers/COPYING
/usr/share/doc/plasma-workspace-wallpapers/COPYING.LGPL3
