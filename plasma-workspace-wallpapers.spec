...
Source0  : https://download.kde.org/stable/plasma/5.20.4/plasma-workspace-wallpapers-5.20.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.4/plasma-workspace-wallpapers-5.20.4.tar.xz.sig
...
%prep
%setup -q -n plasma-workspace-wallpapers-5.20.4
cd %{_builddir}/plasma-workspace-wallpapers-5.20.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606845182
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-workspace-wallpapers-5.20.4/COPYING %{buildroot}/usr/share/package-licenses/plasma-workspace-wallpapers/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/plasma-workspace-wallpapers-5.20.4/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/plasma-workspace-wallpapers/f45ee1c765646813b442ca58de72e20a64a7ddba
pushd clr-build
%make_install
popd
