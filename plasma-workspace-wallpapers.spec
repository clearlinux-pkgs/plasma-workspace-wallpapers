...
Version  : 6.2.0
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.2.0/plasma-workspace-wallpapers-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma-workspace-wallpapers-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma-workspace-wallpapers-6.2.0.tar.xz.sig
...
%setup -q -n plasma-workspace-wallpapers-6.2.0
cd %{_builddir}/plasma-workspace-wallpapers-6.2.0
pushd ..
cp -a plasma-workspace-wallpapers-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728612351
mkdir -p clr-build
pushd clr-build
