...
Source0  : https://download.kde.org/stable/plasma/5.27.5/plasma-workspace-wallpapers-5.27.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.5/plasma-workspace-wallpapers-5.27.5.tar.xz.sig
...
%prep
%setup -q -n plasma-workspace-wallpapers-5.27.5
cd %{_builddir}/plasma-workspace-wallpapers-5.27.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684806252
mkdir -p clr-build
pushd clr-build
